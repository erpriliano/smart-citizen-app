...
const navigationItems: readonly NavigationItem[] = [
  {
    key: 'overview',
    label: 'Overview',
    path: administrativeRoutePaths.overview,
    permission: null,
  ...
  },
  {
    key: 'houses',
    label: 'Houses',
    path: administrativeRoutePaths.houses,
  ...
  },
  {
    key: 'residents',
    label: 'Residents',
    path: administrativeRoutePaths.residents,
    permission: 'residency.record.read',
    icon: UsersIcon,
  },
  {
    ...
    path: administrativeRoutePaths.residencyChanges,
  ...
  },
  {
    ...
    path: administrativeRoutePaths.financialReports,
  ...
  },
  {
    key: 'publications',
    label: 'Publications',
    path: administrativeRoutePaths.publications,
  ...
  },
  {
    ...
    path: administrativeRoutePaths.team,
  ...
  },
  {
    key: 'audit-trail',
    label: 'Audit trail',
    path: administrativeRoutePaths.audit,
  ...
  },
  {
    ...
    path: administrativeRoutePaths.settings,
